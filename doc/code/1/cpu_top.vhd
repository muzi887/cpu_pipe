...
architecture rtl of cpu_top is
  ...
  signal ex_mem_alu_src    : std_logic;
  ...
  begin
    if ex_mem_we = '1' and ex_mem_mr = '0' and ex_mem_rd /= "0000" and ex_mem_rd = rs then
      return "01";
    elsif mem_wb_we = '1' and mem_wb_rd /= "0000" and mem_wb_rd = rs then
      return "10";
    else
      return "00";
    end if;
...
begin
  ...
  forward_b <= forward_sel(
    id_ex_rd, ex_mem_rd, ex_mem_reg_write, ex_mem_mem_read,
    mem_wb_rd, mem_wb_reg_write
  );
  ...
  pc_en <= '1';
  branch_target <= ex_branch_target;
  jump_target <= "0000" & id_ex_instr(11 downto 0);
